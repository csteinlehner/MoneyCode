...
updated_at: 2026-04-10T08:48:27Z
---
...
## Summary of Changes\n\nAlready resolved. The service worker () was updated to use a network-first strategy for all non-font resources, with cache-first only for immutable font files. Combined with `skipWaiting()` and `clients.claim()`, this ensures users always get the latest version.
